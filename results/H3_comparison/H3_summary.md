...
- Deterministic Precision: **0.9941- Learned Precision: **0.9941- Δ Precision (Det - Learn): **0.0- Wilcoxon p-value (paired actionable correctness): **None## Score Consistency (Stability)

- Deterministic Variance Reduction: **0.004956- Learned Variance Reduction: **0.004956- Δ Variance Reduction (Det - Learn): **0.0## Baseline Discrimination & Calibration (for context)

- AUROC: **0.9984300940438872**, PR-AUC: **0.99938730235757- Brier: **0.054733**, ECE: **0.180211## Expected Loss (optional)

- Sum(Expected Loss): **None## Reproducibility
