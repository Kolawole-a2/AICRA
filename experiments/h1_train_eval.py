...
def main():
    ...
    parser = argparse.ArgumentParser(description="H1: Static PE Classification Reliability")
    parser.add_argument(
        "--output-dir",
        type=Path,
    ...
    try:
        ...
        if 'improvement' in metrics:
            logger.info(f"AUROC improvement: {metrics['improvement'].get('auroc_pct', 'N/A'):.2f}%")
