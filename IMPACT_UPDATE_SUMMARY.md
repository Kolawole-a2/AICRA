...
- ✅ Updated: `scenario_impacts["ransomware_encryption"]` from 10,000,000 to **5,000,000**
- Location: Line 180 in default banking configuration

### 3. Policy Writer (`aicra/utils/policy_writer.py`)
- ✅ Updated: `scenario_impacts["ransomware_encryption"]` from 10,000,000 to **5,000,000**
- Location: Line 102 in scenario-based impact selection
