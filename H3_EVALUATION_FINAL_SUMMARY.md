...
2. **`config/h3_splits.yaml`**
   - Configuration file for evaluation splits

3. **`run_h3_evaluation.py`**
   - Main entry point script

4. **`docs/h3_evaluation_README.md`**
   - Detailed usage guide and documentation

5. **`H3_PIPELINE_CLEANUP_SUMMARY.md`**
   - Summary of cleanup and unification
...
1. **`README.md`**
   - Added comprehensive "H3 – Deterministic vs Learned ATT&CK–D3FEND Mapping Evaluation" section
   - Updated to reference new canonical pipeline

2. **`docs/heuristic_mapping.md`**
   - Updated references from old `H3_comparison` script to new `aicra.experiments.h3_evaluation` module
...
1. **`H3_full_results.json`**
   - Complete per-split metrics
...
- ✅ **No allow_pickle=True** (safe data loading)
- ✅ **Does not overwrite** deterministic or learned CSV mappings
- ✅ **Cohesive, testable functions**
...
- ✅ **Statistical tests without forced conclusions**
- ✅ **Data-driven conclusion** section in report
