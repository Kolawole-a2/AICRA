...
**Per Split:**
- **Deterministic:** 100.00% (by definition, across all splits)
- **Learned:** 0.00% (no overlap with deterministic pairs)

**Aggregated:**
- **Mean DAC_internal_det:** 100.00% (SD: 0.00%)
- **Mean DAC_internal_learned:** 0.00% (SD: 0.00%)
- **Mean ΔDAC_internal:** 100.00% (SD: 0.00%)

**Interpretation:**
The learned mapping has **zero overlap** with the deterministic mapping pairs. This means:
...
**Per Split:**
- **Deterministic:** 0.00% (no overlap with 15-pair reference)
- **Learned:** 5.79% (11/190 pairs match reference)

**Aggregated:**
- **Mean DAC_external_det:** 0.00% (SD: 0.00%)
...
- **Deterministic:** 0.0000 (SD: 0.0000)
- **Learned:** 0.2485 (SD: 0.4971)
- **ΔPrecision:** -0.2485 (SD: 0.4971)

**Variance Reduction:**
- **Deterministic:** 0.010792 (SD: 0.018730)
