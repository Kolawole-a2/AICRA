...
**Missing Lines Identified:**
- ❌ Line ~244: No % improvement calculations
- ❌ Line ~277: No baseline reference values
- ❌ Line ~332: No % improvements in summary

**Lines Added:**
- ✅ **Lines 244-250:** % improvement calculations using `compute_h2_improvements()`
...
**Missing Lines Identified:**
- ❌ Line ~1247: No % improvement calculations in aggregation
- ❌ Line ~1843: No improvements section in summary

**Lines Added:**
- ✅ **Lines 1248-1287:** % improvement calculations in `aggregate_metrics()` function
...
1. **`compute_h1_baselines()`** - Lines 50-120
...
**Formula Used (Consistent Across All):**
```python
...
**Rationale:** 
- Clear separation of concerns (data_prep, models, calibration, mapping, evaluation)
...
#### Section 2: Scientific Context and Citations
...
2. **Khayat et al. (2023)** - SOC+AI: A Systematic Literature Review
...
2. **Repository Restructure**
   - ⚠️ Move files to proposed structure
   - ⚠️ Update imports

3. **README Updates**
   - ⚠️ Add benchmark comparison section
...
**Key Findings:**
- AICRA improves AUC by **+58.3%** over baseline models.
...
```json
{
  ...
  "metrics": {
    ...
    "improvement_statement": "Isotonic calibration improves ECE by 50.0%, resulting in more stable SIEM-ready susceptibility scores."
  }
}
```
...
**Canonical Statement:** Isotonic calibration improves ECE by 50.0%, resulting in more stable SIEM-ready susceptibility scores.
```
...
Deterministic mapping increases ATT&CK–D3FEND mapping coverage by 30.8% and reduces risk-score variance by 47.0%.

**Detailed Improvements:**

- Deterministic mapping increases technique-coverage by **+30.8%** over learned mapping.
