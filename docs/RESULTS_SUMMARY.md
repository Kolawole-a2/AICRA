...
**Hypothesis**: Isotonic calibration improves susceptibility score transferability, producing more decision-aligned scores than uncalibrated F1-optimized thresholds.
