...
try:
    ...
    if "aggregated_metrics" in results:
        ...
        print(f"  DAC - Det: {det_dac:.2f}%, Learned: {lrn_dac:.2f}%, Delta: {delta_dac:.2f}%")
    ...
    print(f"\nResults saved to:")
    print(f"  - results/H3_full_evaluation/H3_full_results.json")
    print(f"  - results/H3_full_evaluation/H3_full_summary.md")
    print(f"  - results/H3_full_evaluation/plots/")
