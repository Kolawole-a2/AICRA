...
print(f"  Created: results/small_ember/risk_scores.csv ({len(h3_small)} records, {h3_small['technique_id'].notna().sum()} with technique_id)")
...
print(f"  Created: results/full_ember/risk_scores.csv ({len(h3_full)} records, {h3_full['technique_id'].notna().sum()} with technique_id)")
