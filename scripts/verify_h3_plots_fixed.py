...
if not results_path.exists():
    ...
    print(
        "   python -m aicra.experiments.h3_evaluation --output results/H3_full_evaluation"
    )
    exit(1)
...
if abs(delta_prec) < 0.0001 and abs(delta_var) < 0.000001 and abs(delta_dac) < 0.01:
    ...
    print(
        "   2. Then: python -m aicra.experiments.h3_evaluation --output results/H3_full_evaluation"
    )
    exit(1)
else:
