...
print(f"  DAC det: {aggregated['deterministic']['dac_%']['mean']:.2f}% ± {aggregated['deterministic']['dac_%']['std']:.2f}%")
print(f"  DAC learned: {aggregated['learned']['dac_%']['mean']:.2f}% ± {aggregated['learned']['dac_%']['std']:.2f}%")
print(f"  Precision det: {aggregated['deterministic']['actionable_precision']['mean']:.4f} ± {aggregated['deterministic']['actionable_precision']['std']:.4f}")
print(f"  Precision learned: {aggregated['learned']['actionable_precision']['mean']:.4f} ± {aggregated['learned']['actionable_precision']['std']:.4f}")
