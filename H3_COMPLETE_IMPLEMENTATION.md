...
### JSON Results
- **`results/H3_comparison/H3_full_results.json`**
  - Complete results with `mapping_interpretation` at top level

### Markdown Report
- **`results/H3_comparison/H3_full_summary.md`**
  - Includes "## 4. Mapping Interpretation" section

### Diagnostic Plots
- **`results/H3_comparison/diagnostics/distribution_density_{split}.png`**
- **`results/H3_comparison/diagnostics/distribution_boxplot_{split}.png`**
- **`results/H3_comparison/diagnostics/distribution_scatter_{split}.png`**

### Standard Plots
- **`results/H3_comparison/plots/dac_per_split.png`**
- **`results/H3_comparison/plots/precision_per_split.png`**
- **`results/H3_comparison/plots/variance_reduction_per_split.png`**
- **`results/H3_comparison/plots/summary_metrics.png`**

## Features Implemented

✅ **1. Results Validation**
   - Automatic checks for precision/F1 improvement
   - Variance/IQR change detection
   - Contradiction detection

✅ **2. Diagnostic Code**
   - Checks if mapped_precision > baseline_precision
   - Checks if mapped_f1 > baseline_f1
   - Checks variance/IQR changes
   - Detects contradictions

✅ **3. Interpretation Block**
   - In JSON: `mapping_interpretation` object
