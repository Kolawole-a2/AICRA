...
class DriftPipeline:
    ...
    def run(
        ...
        column_mapping = ColumnMapping(
            ...
            numerical_features=[
                col for col in reference_data.columns if col.startswith("feature_")
            ],
        )
    ...
    def _extract_drift_metrics(
        self, report: Report, test_suite: TestSuite
    ) -> dict[str, Any]:
    ...
    def _check_severe_drift(
        self, drift_metrics: dict[str, Any], threshold: float
    ) -> bool:
