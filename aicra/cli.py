...
def data(
    action: str = typer.Argument(
        ..., help="Action to perform: fetch, validate, snapshot"
    ),
    data_dir: str | None = typer.Option(None, help="Data directory path"),
    sample_size: int | None = typer.Option(None, help="Sample size for testing"),
...
def train(
    ...
    sample_size: int | None = typer.Option(None, help="Sample size for training"),
    seed: int = typer.Option(42, help="Random seed"),
...
def eval(
    ...
    sample_size: int | None = typer.Option(None, help="Sample size for evaluation"),
):
...
def predict(
    ...
    output_file: str | None = typer.Option(None, help="Output file for predictions"),
...
def drift(
    ...
    output_dir: str = typer.Option(
        "artifacts", help="Output directory for drift report"
    ),
):
...
def calibrate(
    ...
    data_dir: str = typer.Option("data/ember2024", help="Data directory path"),
    output_dir: str = typer.Option(
        "artifacts", help="Output directory for calibration results"
    ),
    method: str = typer.Option(
        "isotonic", help="Calibration method: isotonic or platt"
    ),
):
...
def optimize_threshold(
    ...
    data_dir: str = typer.Option("data/ember2024", help="Data directory path"),
    output_dir: str = typer.Option(
        "artifacts", help="Output directory for threshold analysis"
    ),
    ...
    try:
        ...
        console.print(
            f"✅ Threshold optimization completed. Results saved to: {output_dir}"
        )
