...
class TestSmokeTestPipeline:
    ...
    def test_ensure_directories(self, smoke_pipeline):
        ...
        for dir_path in [
            smoke_pipeline.artifacts_dir,
            smoke_pipeline.data_dir,
            smoke_pipeline.models_dir,
            smoke_pipeline.policies_dir,
    ...
    def test_run_exception_handling(self, smoke_pipeline):
        ...
        with patch.object(
            smoke_pipeline, "_ensure_directories", side_effect=Exception("Test error")
        ):
